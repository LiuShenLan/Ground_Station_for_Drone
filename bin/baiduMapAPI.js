window.TILE_VERSION = {
    "ditu": {
        "normal": {"version": "088", "updateDate": "20220106"},
        "satellite": {"version": "009", "updateDate": "20220106"},
        "normalTraffic": {"version": "081", "updateDate": "20220106"},
        "satelliteTraffic": {"version": "083", "updateDate": "20220106"},
        "mapJS": {"version": "104", "updateDate": "20220106"},
        "satelliteStreet": {"version": "083", "updateDate": "20220106"},
        "earthVector": {"version": "001", "updateDate": "20220106"}
    },
    "webapp": {
        "high_normal": {"version": "001", "updateDate": "20220106"},
        "lower_normal": {"version": "002", "updateDate": "20220106"}
    },
    "api_for_mobile": {
        "vector": {"version": "002", "updateDate": "20220106"},
        "vectorIcon": {"version": "002", "updateDate": "20220106"}
    }
};
window.BMAP_AUTHENTIC_KEY = "WiUtV0vfMqRuCVqducdBKyo2GO4dKeWV";
(function () {
    function aa(a) {
        throw a;
    }
    ...
    x.K.wj = function (a, b) {
        var c = x.K, a = c.$(a);
        if (a === p) return a;
        var b = x.Zk.QO(b), d = a.style[b];
        if (!d) var e = c.WB[b], d = a.currentStyle || (x.da.ma ? a.style : getComputedStyle(a, p)),
    ...
    x.K.ia = function (a) {
        a = x.K.$(a);
        if (a === p) return a;
        var b = x.K.ZD(a), c = x.da, d = x.K.wj;
    ...
    var sa = window.BMap_loadScriptTime, ta = (new Date).getTime(), ua = p, va = o, wa = 5042, xa = 5002, ya = 5003,
        za = "load_mapclick", Aa = 5038, Ba = 5041, Ca = 5047, Ea = 5036, Fa = 5039, Ga = 5037, Ha = 5040, Ia = 5011,
        Ja = 7E3;
    var Ka = 0;
    ...
    x.extend(La.prototype, {
        va: function () {
            ...
            var b = this;
            if (a instanceof O || a instanceof K) a = new K(Za(a, b).lng, Za(a, b).lat), b.Ai(a, {noAnimation: o}); else if (bb(a)) if (b.xb === Qa) {
                var c = I.xC[a];
                c && (pt = c.m, b.Xf(pt))
            } else {
                var d = this.bI();
            ...
            if (bb(a)) if (c.xb === Qa) {
                ...
                e.PF(function (d) {
                    if (0 === e.Im() && (2 === e.Ga.result.type || 11 === e.Ga.result.type)) {
                        var d = d.Ek(0).point, f = b || P.xx(e.Ga.content.level, c);
                        c.Gd(d, f);
                        Qa.Ak(a) && c.JF(a)
                    }
                });
            ...
            if (a) {
                var a = Za(a, this), c = this.Cc(new K(a.lng, a.lat), b);
                c.x -= this.offsetX;
                c.y -= this.offsetY;
                return c
            }
            ...
            var b = a || {}, a = b.margins || [0, 0, 0, 0], c = b.zoom || p,
                b = this.Ag({x: a[3], y: this.height - a[2]}, c), a = this.Ag({x: this.width - a[1], y: a[0]}, c);
            return new hb(b, a)
        }, by: function () {
            return !!this.loaded
        }, lS: function (a, b) {
            ...
            if (a && b) {
                if (a.ab(b)) return 0;
                var a = Za(a, this), b = Za(b, this), c = 0, c = T.fp(a, b);
                if (c === p || c === j) c = 0;
                return c
            }
        }, Mx: function () {
            ...
            var a = this.xb.hp(), b = this.xb.Dm(), c = this.B;
            c.fc = c.hP || a;
            c.Zb = c.gP || b;
            c.fc < a && (c.fc = a);
            c.Zb > b && (c.Zb = b)
            ...
            var a = this.ga() >= this.B.lG && this.oa() === Na && 18 >= this.ga(), b = q;
            try {
    ...
    function xb(a) {
        var b = cb();
        b >= a.pA ? ($a(a.k.va) && a.k.va(a.k.hc(1)), $a(a.k.finish) && a.k.finish(), 0 < a.$f.length && (b = a.$f[0], b.$f = [].concat(a.$f.slice(1)), b.start())) : (a.Oy = a.k.hc((b - a.Xu) / a.k.duration), $a(a.k.va) && a.k.va(a.Oy), a.YF || (a.fs = setTimeout(function () {
            xb(a)
        }, 1E3 / a.k.Hc)))
    }
    ...
    void function (a, b, c) {
        void function (a, b, c) {
            function g(a) {
                if (!a.So) {
                    for (var c = o, d = [], f = a.PZ, i = 0; f && i < f.length; i++) {
                        var k = f[i], l = ba[k] = ba[k] || {};
                        if (l.So || l == a) d.push(l.Lc); else {
                            c = q;
            ...
            function k(a, b, c) {
                if (a) {
                    ...
                    try {
                        a == G ? (Q[b] = Q[b] || [], Q[b].unshift(c)) : a.addEventListener ? a.addEventListener(b, c, q) : a.attachEvent && a.attachEvent("on" + b, c)
                    } catch (d) {
                    }
                }
            }
            ...
            var D = c.alog;
            if (!D || !D.So) {
                var C = b.all && a.attachEvent, F = D && D.QE || +new Date,
                    z = a.R3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), A = 0, E = {},
                    G = function (a) {
                ...
                w.prototype.set = function (a, b) {
                    if ("string" == typeof a) "protocolParameter" == a && (b = u({
                        postUrl: p,
                        protocolParameter: p
                    }, b)), this.Vs[a] = b; else if ("object" == typeof a) for (var c in a) this.set(c, a[c])
                };
        ...
        void function (a, b, c) {
            ...
            var k = Math.random, i = i + "/tb/pms/img/st.gif", l = {Bh: "0.1"}, m = {Bh: "0.1"}, n = {Bh: "0.1"},
                s = {Bh: "0"};
            if (l && l.Bh && k() < l.Bh) {
    ...
    var Vb = [72.6892532, 0.1939743381, 136.1168614, 54.392257],
        Wb = [72.69566833, 0.1999420909, 136.1232863, 54.39791217], Xb = 158,
        ...
        ec = 3E3, fc = 2.0E-5, gc = 3.0E-6, hc = 0.0174532925194, ic = 0.0065, jc = 0.0060, kc = 4E4, lc = 0, mc = 3,
        nc = 1.0E-10, oc = 6370996.81, pc = 1E8;
    ...
    function rc(a) {
        var b = a.lng, c = a.lat, a = Math.sqrt(b * b + c * c) + Math.sin(c * ec * hc) * fc,
            b = Math.atan2(c, b) + Math.cos(b * ec * hc) * gc;
        return {lng: a * Math.cos(b) + ic, lat: a * Math.sin(b) + jc}
    }

    function sc(a) {
        var b = tc, c = {}, d = a.lng, e = a.lat, f = 1, g = a.lng, i = a.lat, k = d - f, l = 0, m = e + f, n = 0,
            s = d - f, u = 0, w = e - f, y = 0, D = d + f, C = 0, F = e - f, z = 0, A = d + f, E = 0, G = e + f, Q = 0,
            m = k = 0, m = uc(b, d, e), k = m.lng, m = m.lat;
        ...
        for (; ;) {
            ...
            if (1.0E-6 > f) {
                a:{
                    ...
                    C = j;
                    for (G = 0; G <= c; G++) {
                        for (d = 0; d <= f; d++) if (C = b(j), E = j.lng * pc, u = j.lat * pc, l = C.lng * pc, C = C.lat * pc, !(l < k || C < s || l > m || C > D)) {
                            E -= l;
                            u -= C;
    ...
    function Ac(a, b) {
        var c = a.lat * hc, d = b.lat * hc, e = c - d, f = a.lng * hc - b.lng * hc;
    ...
    function tc(a) {
        ...
        for (var b = 0, c = kc, d = 0, e = new yc, f = 0, d = 0; d < $b; ++d) bc[d] <= a.lat ? bc[(d + 1) % $b] > a.lat && 0 < Bc({
            lng: ac[d],
            lat: bc[d]
        }, {lng: ac[(d + 1) % $b], lat: bc[(d + 1) % $b]}, a) && ++f : bc[(d + 1) % $b] <= a.lat && 0 > Bc({
            lng: ac[d],
            lat: bc[d]
        }, {lng: ac[(d + 1) % $b], lat: bc[(d + 1) % $b]}, a) && --f;
        if ((0 === f ? lc : mc) === lc) {
            for (f = 0; f < $b; ++f) if (d = new zc(ac[f], bc[f], ac[(f + 1) % $b], bc[(f + 1) % $b]), e.wg.lng = d.oy.wg.lng - 0.5, e.wg.lat = d.oy.wg.lat - 0.5, e.Eg.lng = d.oy.Eg.lng + 0.5, e.Eg.lat = d.oy.Eg.lat + 0.5, e.contains(a) !== lc) {
                var g;
                var i = d.pu.lng, k = d.pu.lat, l = d.vx.lng, m = d.vx.lat;
                g = m - k;
                var n = i - l;
                !(Math.abs(g - 0) > nc) && !(Math.abs(n - 0) > nc) ? g = d.pu : (i = l * k - i * m, k = n * a.lng - g * a.lat, l = g * g - n * n, g = {
                    lng: (n * k - g * i) / l,
                    lat: -(g * k + n * i) / l
                });
                n = 180;
    ...
    function Cc(a) {
        ...
        if (qc(a, Yb, Zb)) {
            var b = a.lng - ic, c = a.lat - jc, a = Math.sqrt(b * b + c * c) - Math.sin(c * ec * hc) * fc,
                b = Math.atan2(c, b) - Math.cos(b * ec * hc) * gc;
    ...
    function ra(a, b) {
        ...
        d.charset = "utf-8";
        var e = window.___abvk ? window.___abvk : Ec("SECKEY_ABVK"), f = Ec("BMAP_SECKEY");
    ...
    x.object.extend(L, {
        Lj: {IG: -1, eQ: 0, mq: 1},
        KL: function () {
            var a = "canvablepath", b = B.dV ? "newvectordrawlib" : "vectordrawlib";
                ...
                if (d.Dd == this.Lj.IG) {
                    ...
                    e.UC == q && (e.UC = o, setTimeout(function () {
                        for (var a = [], b = 0, c = e.Sd.Nn.length; b < c; b++) {
                            var d = e.Sd.Nn[b], l = "";
                            ja.dz.yK(d) ? l = ja.dz.get(d) : (l = "", a.push(d + "_" + Fc[d]));
    ...
    (function (a) {
        ...
        function m(a, b) {
            var c = unescape(encodeURIComponent(a)), d = unescape(encodeURIComponent(b)), e = k(c), f = [], l = [];
            f[15] = l[15] = j;
    ...
    for (var Gc = function (a, b) {
        ...
        function e(a, b) {
            for (var c = "eac"; f.lcmea(c, f.eeilc);) switch (c) {
                case "eic":
        ...
        var f = {
            lcmea: function (a, b) {
                return a !== b
            }, eeilc: "dlcc", haiee: function (a, b) {
                return a < b
            }, mxeed: function (a, b) {
                return a(b)
            }, cchea: "dae", emehl: "eia", hiaac: "eic", aaeda: "constructor", hmlml: function (a, b) {
                return a(b)
            }, eeicl: function (a, b) {
                return a + b
            }, emhhd: function (a, b) {
    ...
    var Lc = function (a) {
        for (var b = {
            ...
            dcahd: V("0x9"),
            axeha: V("0xa")
        }, c = "hac"; c !== b.deemd;) switch (c) {
            case V("0x9"):
                var d = a ? a : 5E3, c = b[V("0xb")];
                break;
            case b[V("0xc")]:
                var e = 0, c = b[V("0xd")];
                break;
            case b[V("0xb")]:
                return function (a) {
                    for (var c = "ahl"; b[V("0xe")](c, V("0x5"));) switch (c) {
                        case V("0x4"):
                            f = setTimeout(function () {
                                for (var a = {
                                    aadde: function (a, b) {
                                        return a === b
                                    }, hchhe: "error", aeaac: b[V("0xf")], xamdx: function (a, b) {
                                        return a === b
                                    }
                                }, c = V("0x10"); b[V("0xe")](c, V("0x11"));) switch (c) {
                                    case b.lacae:
                                        ra(d, function (b) {
                                        ...
                                        break;
                                    case V("0x10"):
                                        var d = b[V("0x16")](B.JN + V("0x17") + qa, V("0x18")) + e, c = V("0x1");
                                        break;
                                    case V("0x19"):
                                        f = p;
                                        c = V("0x11");
    ...
    function Mc(a, b) {
        for (var c = {
            ...
            hciaa: V("0x29"),
            ielde: "ilc"
        }, d = V("0x21"); d !== c[V("0x2a")];) switch (d) {
            case c[V("0x2b")]:
                var e = c.mcehl(c[V("0x2c")](a, "-") + c[V("0x2d")](m, n) + "-0-0-", l), d = V("0x23");
                break;
            case c[V("0x2e")]:
                return s;
            case V("0x2f"):
            ...
            case c[V("0x32")]:
                ...
                break;
            case c[V("0x33")]:
                var f = Date[V("0x34")](new Date), d = V("0x35");
                break;
            case c[V("0x36")]:
                var g, i, d = c[V("0x37")];
                break;
            case c[V("0x38")]:
                var k = c[V("0x39")](md5, e), d = V("0x27");
                break;
            case V("0x26"):
                g = b.fW ? b.fW : 1;
                d = V("0x2f");
            ...
            case V("0x22"):
                ...
                break;
            case V("0x35"):
                var m = c[V("0x3e")](f, 1E3), d = c[V("0x2b")];
                break;
            case V("0x3f"):
                var n = 1800, d = c[V("0x33")];
                break;
            case c[V("0x40")]:
                var s = c[V("0x2d")](c.execx(c[V("0x41")], c[V("0x42")](m, n)) + c[V("0x43")], k), d = V("0x25");
                break;
            case c[V("0x44")]:
                g = 1, d = V("0x1f")
        }
    ...
    function Jc(a, b) {
        var c = {
            eelde: function (a, b) {
                return a + b
            }, dclll: V("0x45"), celcx: function (a, b) {
                return a === b
            }, eciha: V("0x46"), aaclh: function (a, b) {
                return a + b
            }
        };
        switch (a) {
    ...
    x.extend(kb.prototype, {
        ...
        }, ia: v("Kb"), hu: da("Xg"), nE: v("Xg"), setUserData: da("NJ"), getUserData: v("NJ")
    });
    ...
    x.extend(Nc.prototype, {
        initialize: function (a) {
            ...
            if (this.T1 || !Ya(a) || isNaN(a) || a < Oc || 3 < a) a = this.defaultAnchor;
            this.k = this.k || {Dg: q};
    ...
    x.object.extend(Sc.prototype, {
        initialize: function (a) {
            ...
            if (a && Ya(a.id) && !isNaN(a.id)) {
                ...
                for (c in a) b[c] = a[c];
                if (a = this.Am(a.id)) for (var d in b) a[d] = b[d]; else this.bc.push(b)
            }
        }, Am: function (a) {
            for (var b = 0, c = this.bc.length; b < c; b++) if (this.bc[b].id == a) return this.bc[b]
        }, YD: v("bc"), uF: function (a) {
    ...
    function mb(a) {
        ...
        this.qc(a.anchor);
        this.ei = {
            metric: {name: "metric", GK: 1, sM: 1E3, aP: "\u7c73", bP: "\u516c\u91cc"},
            us: {name: "us", GK: 3.2808, sM: 5280, aP: "\u82f1\u5c3a", bP: "\u82f1\u91cc"}
        };
    ...
    var $c = I.pa + "menu_zoom_in.png", ad = I.pa + "menu_zoom_out.png";
    ...
    x.extend(T, {
        ...
        tb: function (a) {
            ...
            a.lat = this.jE(a.lat, -74, 74);
            b = new K(a.lng, a.lat);
            for (var d = 0; d < this.Ou.length; d++) if (b.lat >= this.Ou[d]) {
                c = this.JG[d];
                break
            }
            if (!c) for (d = 0; d < this.Ou.length; d++) if (b.lat <= -this.Ou[d]) {
                c = this.JG[d];
                break
            }
            a = this.JK(a, c);
    ...
    x.extend(T.prototype, {
        Jk: function (a) {
            ...
            if (a) return a = this.Jk(a, e), b = this.yc(b), new R(Math.round((a.lng - c.lng) / b + d.width / 2), Math.round((c.lat - a.lat) / b + d.height / 2))
    ...
    x.extend(jb.prototype, {
        Jk: function (a, b) {
            ...
            L.load("coordtrans", function () {
                var a = dd.hE(c.ij || "bj", d), a = new R(a.x, a.y);
                b && b(a)
            }, o)
        }, pointToLngLatFor3D: function (a, b) {
            var c = this, d = new K(a.x, a.y);
            L.load("coordtrans", function () {
                var a = dd.gE(c.ij || "bj", d), a = new K(a.lng, a.lat), a = T.ub(a);
                b && b(a)
            }, o)
        }, cR: function (a, b) {
    ...
    x.extend(ib.prototype, {
        initialize: function (a) {
            ...
            return p
        }, Hx: v("map"), draw: t(), Oj: t(), remove: function () {
            this.map = p;
            x.lang.lx(this.ba);
        ...
        }, Ka: v("V"), kO: function (a) {
            var a = a || {}, b;
            for (b in a) this.z[b] = a[b]
        }, iu: da("zIndex"), qj: function () {
            this.z.qj = o
        }, FW: function () {
            this.z.qj = q
        }, Fo: da("ig"), Op: function () {
            this.ig = p
        }
    });
    ...
    B.Xe(function (a) {
        ...
        a.addEventListener("addoverlay", function (a) {
            a = a.target;
            if (a instanceof ib) b.wa[a.ba] || (b.wa[a.ba] = a); else {
        ...
        a.addEventListener("removeoverlay", function (a) {
            a = a.target;
            if (a instanceof ib) delete b.wa[a.ba]; else for (var d = 0, e = b.Fe.length; d < e; d++) if (b.Fe[d] === a) {
                b.Fe.splice(d, 1);
                break
            }
        });
    ...
    x.extend(kd.prototype, {
        setPath: da("CB"), setAnchor: function (a) {
    ...
    function ld(a, b, c, d) {
        a && (this.Rv = {}, this.vL = d ? !!d : q, this.jd = [], this.U_ = a instanceof kd ? a : p, this.aJ = b === j ? o : !!(b.indexOf("%") + 1), this.gk = isNaN(parseFloat(b)) ? 1 : this.aJ ? parseFloat(b) / 100 : parseFloat(b), this.bJ = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.bJ ? parseFloat(c) / 100 : parseFloat(c) : 0)
    }
    ...
    x.extend(md.prototype, {
        setWidth: function (a) {
            ...
            return this.z.title
        }, ad: da("content"), Bk: v("content"), eu: function (a) {
            this.z.$E = a + ""
        }, le: t(), Rs: function () {
            this.z.Rs = o
    ...
    function vd(a, b) {
        var c = this;
        ud() && (a === j && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, ib.apply(c, arguments), c.ea = {ha: a}, c.z = {
            shape: b.shape || sd,
            size: b.size || td,
    ...
    x.extend(Cd.prototype, {
        ra: function () {
            ...
            var d = this.map, e = d.oa(), f = d.Na, g = d.dc, i = e.yc(f), k = this.IL(), l = k[0], m = k[1], n = k[2],
                s = k[3], u = k[4], c = "undefined" != typeof c ? c : 0, e = e.k.Ob, k = d.ba.replace(/^TANGRAM_/, "");
            ...
            if (l = this.$m) for (var C in l) delete l[C]; else this.$m = {};
            ...
            for (d = this.Rc.length; l < d; l++) {
                ...
                i = this.Rc[l][1];
                w = 0;
                for (m = this.Oe.length; w < m; w++) if (n = this.Oe[w], n.id == k + "_" + b + "_" + C + "_" + i + "_" + f) {
                    n.tr = o;
                    this.$m[n.id] = n;
                    break
                }
            ...
            var a = this.map, b = a.oa(), c = b.tE(a.Na), d = a.dc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c),
                b = b.k.Ob, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
        }, J_: function (a, b, c, d) {
            var e = this;
            e.e2 = b;
            var f = this.map.oa(), g = e.oE(a, c), i = f.k.Ob, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]],
                k = this.xg[g];
            ...
            k && k.Hb ? (yb(k.Hb, b), d && (d = new R(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Fd(k, d)), k.loaded ? this.zf() : Gd(k, function () {
                e.zf()
            })) : (k = this.hj[g]) && k.Hb ? (c.Pb.insertBefore(k.Hb, c.Pb.lastChild), this.xg[g] = k, yb(k.Hb, b), d && (d = new R(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Fd(k, d)), k.loaded ? this.zf() : Gd(k, function () {
                e.zf()
            })) : (k = i * Math.pow(2, f.Dm() - a[2]), new K(a[0] * k, a[1] * k), d = new R(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new Hd(this, d, b, a, c), Gd(k, function () {
                e.zf()
            }), k.lo(), this.xg[g] = k)
        }, zf: function () {
            this.uh--;
            ...
            var b = this;
            if (b.map.oa() == Qa) L.load("coordtrans", function () {
            ...
            var b = this.Vm.concat(this.Yf), c = b.length, d = this.map, e = d.oa(), f = d.dc;
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.uI && !(i.Ap && !this.map.Wb() || i.EM && this.map.Wb())) {
                    ...
                    var s = e.yc(m), k = e.tE(m), l = Math.ceil(f.lng / k), u = Math.ceil(f.lat / k), w = e.k.Ob,
                        k = [l, u, (f.lng - l * k) / k * w, (f.lat - u * k) / k * w], u = 2 * d.width,
                        n = k[0] - Math.ceil((u / 2 - k[2]) / w), l = k[1] - Math.ceil((d.height / 2 - k[3]) / w),
                        u = k[0] + Math.ceil((u / 2 + k[2]) / w), y = 0;
                    e === Qa && 15 == d.ga() && (y = 1);
                    e = k[1] + Math.ceil((d.height / 2 + k[3]) / w) + y;
                    this.lK = new K(f.lng, f.lat);
                    var D = this.xg, w = -this.lK.lng / s, y = this.lK.lat / s, s = [Math.ceil(w), Math.ceil(y)],
                        f = d.ga(), C;
                    for (C in D) {
                        var F = D[C], z = F.info;
            ...
            if (c instanceof eb) a && !c.Rm && (c.ra(this.map, this.nd), c.Rm = o); else if (c.Gh && this.map.$g(c.Gh), c.Ap) {
            ...
            if (a instanceof eb) b && a.Rm && (a.remove(), a.Rm = q); else {
                a.Gh && this.map.Ah(a.Gh);
                if (a.Ap) for (var b = 0, c = this.Hg.length; b < c; b++) a == this.Hg[b] && this.Hg.splice(b, 1); else {
                    b = 0;
            ...
            var b = this.map.oa();
            if (!this.map.Wb() && (a ? this.map.B.R_ = a : a = this.map.B.R_, a)) for (var c = p, c = "2" == B.kz ? [B.url.proto + B.url.domain.main_domain_cdn.other[0] + "/"] : [B.url.proto + B.url.domain.main_domain_cdn.baidu[0] + "/", B.url.proto + B.url.domain.main_domain_cdn.baidu[1] + "/", B.url.proto + B.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Vm[d]; d++) if (e.xO == o) {
                b.k.Zb = 18;
                e.getTilesUrl = function (b, d) {
                    var e = b.x, e = this.map.gb.os(e, d).nm, k = b.y, l = Ub("normal"), m = 1;
                    this.map.Xx() && (m = 2);
    ...
    x.extend(Dd.prototype, {
        ra: function (a, b) {
            ...
            delete this.Pb
        }, Gt: v("p0"), getTilesUrl: function (a, b) {
    ...
    Nd.prototype.getTilesUrl = function (a, b) {
        ...
        var c = this.UU + c + "level=" + b + "&x=" + a.x + "&y=" + a.y, d = 1;
        this.D.Xx() && (d = 2);
    ...
    var Od = [B.url.proto + B.url.domain.TILES_YUN_HOST[0] + "/georender/gss", B.url.proto + B.url.domain.TILES_YUN_HOST[1] + "/georender/gss", B.url.proto + B.url.domain.TILES_YUN_HOST[2] + "/georender/gss", B.url.proto + B.url.domain.TILES_YUN_HOST[3] + "/georender/gss"],
        Pd = B.url.proto + B.url.domain.main_domain_nocdn.baidu + "/style/poi/rangestyle", Qd = 100;
    ...
    var Sd = [B.url.proto + B.url.domain.TILE_BASE_URLS[0], B.url.proto + B.url.domain.TILE_BASE_URLS[1], B.url.proto + B.url.domain.TILE_BASE_URLS[2], B.url.proto + B.url.domain.TILE_BASE_URLS[3]],
        ...
        Ud = {dark: "dl", light: "ll", normal: "pl"}, Vd = new Dd;
    Vd.xO = o;
    Vd.getTilesUrl = function (a, b, c) {
        var d = a.x, a = a.y, e = Ub("normal"), f = 1, c = Ud[c];
        this.map.Xx() && (f = 2);
    ...
    var Na = new Rd("\u5730\u56fe", Vd, {tips: "\u663e\u793a\u666e\u901a\u5730\u56fe", maxZoom: 19}), Wd = new Dd;
    ...
    Yd.getTilesUrl = function (a, b) {
        var c = a.x, d = a.y, e = Ub("satelliteStreet");
    ...
    var ae = 2, be = 3, ce = 0, de = "bt", ee = "nav", fe = "walk", ge = "bl", he = "bsl", ie = 14, je = 15, ke = 18,
        le = 20, ne = 31;
    ...
    x.extend(re.prototype, {
        ...
        }, toString: ea("TransitRoute"), GU: function (a) {
            return a.replace(/\(.*\)/, "")
        }
    });
    var se = re.prototype;
    ...
    function we(a, b) {
        ...
        this.Ma = [{o: "", Fd: 0, Cn: 0, x: 0, y: 0, qa: -1}, {o: "", Fd: 0, Cn: 0, x: 0, y: 0, qa: -1}, {
            o: "",
            Fd: 0,
            Cn: 0,
            x: 0,
            y: 0,
            qa: -1
        }, {o: "", Fd: 0, Cn: 0, x: 0, y: 0, qa: -1}, {o: "", Fd: 0, Cn: 0, x: 0, y: 0, qa: -1}, {
            o: "",
            Fd: 0,
            Cn: 0,
            x: 0,
    ...
    x.extend(Ke.prototype, {
        Vi: t(), show: t(), U: t(), QF: function (a) {
            this.nc.types = a
        }, tn: function (a) {
            this.Ad.src = a
        }, search: da("ej"), Qy: da("qI")
    });
    var Ua;

    function Pa(a, b) {
        function c() {
            e.k.visible ? ("inter" === e.Le && Va() && e.k.haveBreakId && e.k.indoorExitControl === o ? x.K.show(e.pr) : x.K.U(e.pr), this.Ed && this.k.closeControl && this.Af && this.D && this.D.Ka() === this.C ? x.K.show(e.Af) : x.K.U(e.Af), this.k.forceCloseControl && x.K.show(e.Af)) : (x.K.U(e.Af), x.K.U(e.pr))
        }
        ...
        B._rd["_cbk" + f] = function (a) {
            if (!a || a.error === j || a.error !== 0) Kc("PANORAMA"); else {
    ...
    x.extend(Pa.prototype, {
        ...
        Oc: function (a) {
            a != this.Kc && (a > Me && (a = Me), a < Ne && (a = Ne), a != this.Kc && (this.Kc = a), "cssRender" === this.jk && this.Nc(this.Ea))
        },
        NB: function () {
            if (this.D) for (var a = this.D.Mx(), b = 0; b < a.length; b++) (a[b] instanceof W || a[b] instanceof nd) && a[b].point && this.wa.push(a[b])
        },
        Ry: da("D"),
        fu: function (a) {
            this.Nf = a || "none"
    ...
    x.extend(Te.prototype, {
        ta: function (a) {
            ...
            this.IJ = a;
            this.Mf("title", a)
        }, np: v("IJ"), Vb: function (a) {
            this.lI = icon;
            this.Mf("icon", a)
        }, gp: v("lI"), GF: function (a) {
            this.Fq = a;
            this.Mf("altitude", a)
        }, dp: v("Fq"), iE: v("NT"), Fa: function () {
            var a = p;
            if (this.P) {
                var a = this.P.ia(), b = this.ia(), a = Re(b.lng - a.lng, b.lat - a.lat);
                isNaN(a) && (a = 0);
                a = {heading: a, pitch: 0}
            } else a = this.Ea;
            return a
            ...
            function a(a) {
                if (a) {
                    if (a.id != b.mw) {
                        ...
                        if (b.yl) {
                            var f = b.yl, g = b._position;
                            c = f.lat;
                            var i = g.lat, k = Pb(i - c), f = Pb(g.lng - f.lng);
    ...
    var Ye = Yc.prototype;
    U(Ye, {getPanoramaById: Ye.kp, getPanoramaByLocation: Ye.tj, getPanoramaByPOIId: Ye.Nx});
    ...
    x.extend(af, {
        wp: function (a, b, c, d) {
            if (!b || !c || !c.lngLat || !c.panoInstance) d(); else {
                ...
                this.qo.vC(b, function (b) {
                    b ? e.qo.tj(c.lngLat, af.MP, function (b) {
                        if (b && b.id) {
                            var f = b.id, k = b.wh, b = b.xh, l = Yc.Xd.zl(c.lngLat), m = e.AS(l, {x: k, y: b}),
            ...
            e = [];
            var f = af.Nu.width, g = af.Nu.height;
            e.push(d);
    ...
    a:{
        for (var ff = ["t", "webkitT", "MozT", "msT", "OT"], gf, hf = 0, jf = ff.length; hf < jf; hf++) if (gf = ff[hf] + "ransform", gf in df) {
            ef = ff[hf].substr(0, ff[hf].length - 1);
            break a
        }
        ef = q
    }
    var kf = ef ? "-" + ef.toLowerCase() + "-" : "", mf = lf("transform"), nf = lf("transitionProperty"),
        of = lf("transitionDuration"), pf = lf("transformOrigin"), qf = lf("transitionTimingFunction"),
        rf = lf("transitionDelay"), ye = /android/gi.test(navigator.appVersion),
        sf = /iphone|ipad/gi.test(navigator.appVersion), tf = /hp-tablet/gi.test(navigator.appVersion),
        uf = lf("perspective") in df, vf = "ontouchstart" in window && !tf, wf = ef !== q, xf = lf("transition") in df,
        yf = "onorientationchange" in window ? "orientationchange" : "resize", zf = vf ? "touchstart" : "mousedown",
        Af = vf ? "touchmove" : "mousemove", Bf = vf ? "touchend" : "mouseup", Cf = vf ? "touchcancel" : "mouseup",
        Df = ef === q ? q : {
            "": "transitionend",
    ...
    function Jf(a, b) {
        ...
        c.ca(yf, window);
        c.ca(zf);
        !vf && "none" != c.options.rP && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
    ...
    Jf.prototype = {
        ...
        Vv: function (a) {
            var b;
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = bf.createElement("div"), this.options.DF ? b.className = this.options.DF + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.Hi ? "7" : "2") + "px" : "width:7px;bottom:" + (this.si ? "7" : "2") + "px;top:2px;right:1px"), b.style.cssText += ";pointer-events:none;" + kf + "transition-property:opacity;" + kf + "transition-duration:" + (this.options.bX ? "350ms" : "0") + ";overflow:hidden;opacity:" + (this.options.Vx ? "0" : "1"), this.Fn.appendChild(b), this[a + "ScrollbarWrapper"] = b, b = bf.createElement("div"), this.options.DF || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + kf + "background-clip:padding-box;" + kf + "box-sizing:border-box;" + ("h" == a ? "height:100%" : "width:100%") + ";" + kf + "border-radius:3px;border-radius:3px"), b.style.cssText += ";pointer-events:none;" + kf + "transition-property:" + kf + "transform;" + kf + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + kf + "transition-duration:0;" + kf + "transform: translate(0,0)" + Gf, this.options.Gi && (b.style.cssText += ";" + kf + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"), this[a + "ScrollbarWrapper"].appendChild(b), this[a + "ScrollbarIndicator"] = b), "h" == a ? (this.gM = this.hM.clientWidth, this.qY = cf.max(cf.round(this.gM * this.gM / this.Py), 8), this.pY.style.width = this.qY + "px") : (this.iP = this.jP.clientHeight, this.x0 = cf.max(cf.round(this.iP * this.iP / this.Up), 8), this.w0.style.height = this.x0 + "px"), this.HB(a, o)) : this[a + "ScrollbarWrapper"] && (wf && (this[a + "ScrollbarIndicator"].style[mf] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(this[a + "ScrollbarWrapper"]), this[a + "ScrollbarWrapper"] = p, this[a + "ScrollbarIndicator"] = p)
        },
        GB: function () {
            var a = this;
            setTimeout(function () {
        ...
        Lr: function (a, b) {
            this.dl || (a = this.rp ? a : 0, b = this.Dn ? b : 0, this.options.al ? this.Nb.style[mf] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + Gf : (a = cf.round(a), b = cf.round(b), this.Nb.style.left = a + "px", this.Nb.style.top = b + "px"), this.x = a, this.y = b, this.HB("h"), this.HB("v"))
        },
        HB: function (a, b) {
            var c = "h" == a ? this.x : this.y;
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.KD || (c = this[a + "ScrollbarIndicatorSize"] + cf.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.KD ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - cf.round(3 * (c - this[a + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px", c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))), this[a + "ScrollbarWrapper"].style[rf] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Vx ? "0" : "1", this[a + "ScrollbarIndicator"].style[mf] = "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + Gf)
        },
        aR: function (a) {
        ...
        ew: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (vf && 1 < a.touches.length) && (d = cf.abs(a.touches[0].pageX - a.touches[1].pageX), c = cf.abs(a.touches[0].pageY - a.touches[1].pageY), this.e0 = cf.sqrt(d * d + c * c), this.zy = cf.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.nG) / 2 - this.x, this.Ay = cf.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.oG) / 2 - this.y, this.options.Jp && this.options.Jp.call(this, a));
                if (this.options.py && (this.options.al ? (c = getComputedStyle(this.Nb, p)[mf].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Gi ? this.ae(Df) : Ff(this.mC), this.Gj = [], this.Lr(d, c), this.options.xy && this.options.xy.call(this);
                this.zw = this.x;
                this.Aw = this.y;
                this.su = this.x;
                this.tu = this.y;
        ...
        xT: function (a) {
            var b = vf ? a.touches[0] : a, c = b.pageX - this.wh, d = b.pageY - this.xh, e = this.x + c, f = this.y + d,
                g = a.timeStamp || Date.now();
            this.options.sN && this.options.sN.call(this, a);
            if (this.options.zoom && vf && 1 < a.touches.length) e = cf.abs(a.touches[0].pageX - a.touches[1].pageX), f = cf.abs(a.touches[0].pageY - a.touches[1].pageY), this.d0 = cf.sqrt(e * e + f * f), this.dl = o, b = 1 / this.e0 * this.d0 * this.scale, b < this.options.cl ? b = 0.5 * this.options.cl * Math.pow(2, b / this.options.cl) : b > this.options.kq && (b = 2 * this.options.kq * Math.pow(0.5, this.options.kq / b)), this.Dp = b / this.scale, e = this.zy - this.zy * this.Dp + this.x, f = this.Ay - this.Ay * this.Dp + this.y, this.Nb.style[mf] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + Gf, this.options.GN && this.options.GN.call(this, a); else {
                this.wh = b.pageX;
                this.xh = b.pageY;
        ...
        pv: function (a) {
            if (!(vf && 0 !== a.touches.length)) {
                var b = this, c = vf ? a.changedTouches[0] : a, d, e, f = {Ca: 0, time: 0}, g = {Ca: 0, time: 0},
                ...
                if (b.dl) d = b.scale * b.Dp, d = Math.max(b.options.cl, d), d = Math.min(b.options.kq, d), b.Dp = d / b.scale, b.scale = d, b.x = b.zy - b.zy * b.Dp + b.x, b.y = b.Ay - b.Ay * b.Dp + b.y, b.Nb.style[of] = "200ms", b.Nb.style[mf] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Gf, b.dl = q, b.refresh(), b.options.Ip && b.options.Ip.call(b, a); else {
                    if (b.th) {
                        ...
                        f.Ca || g.Ca ? (c = cf.max(cf.max(f.time, g.time), 10), b.options.ou && (f = d - b.zw, g = e - b.Aw, cf.abs(f) < b.options.az && cf.abs(g) < b.options.az ? b.scrollTo(b.zw, b.Aw, 200) : (f = b.AJ(d, e), d = f.x, e = f.y, c = cf.max(f.time, c))), b.scrollTo(cf.round(d), cf.round(e), c)) : b.options.ou ? (f = d - b.zw, g = e - b.Aw, cf.abs(f) < b.options.az && cf.abs(g) < b.options.az ? b.scrollTo(b.zw, b.Aw, 200) : (f = b.AJ(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.so(200)
                    } else {
                        if (vf) if (b.ZK && b.options.zoom) clearTimeout(b.ZK), b.ZK = p, b.options.Jp && b.options.Jp.call(b, a), b.zoom(b.wh, b.xh, 1 == b.scale ? b.options.JW : 1), b.options.Ip && setTimeout(function () {
                            b.options.Ip.call(b, a)
                        }, 200); else if (this.options.Sx) {
                            for (d = c.target; 1 != d.nodeType;) d = d.parentNode;
                            e = d.tagName.toLowerCase();
                            "select" != e && "input" != e && "textarea" != e ? (e = bf.createEvent("MouseEvents"), e.initMouseEvent("click", o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, p), e.WR = o, d.dispatchEvent(e)) : d.focus()
                        }
                        b.so(400)
                    }
        ...
        so: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.th && (this.th = q, this.options.xy && this.options.xy.call(this)), this.si && this.options.Vx && ("webkit" == ef && (this.hM.style[rf] = "300ms"), this.hM.style.opacity = "0"), this.Hi && this.options.Vx) "webkit" == ef && (this.jP.style[rf] = "300ms"), this.jP.style.opacity = "0"
        ...
        TB: function () {
            ...
            a.em || (a.Gj.length ? (e = a.Gj.shift(), e.x == b && e.y == c && (e.time = 0), a.em = o, a.th = o, a.options.Gi) ? (a.JJ(e.time), a.Lr(e.x, e.y), a.em = q, e.time ? a.ca(Df) : a.so(0)) : (g = function () {
                var i = Date.now(), k;
                if (i >= d + e.time) {
                    a.Lr(e.x, e.y);
                    a.em = q;
        ...
        zoom: function (a, b, c, d) {
            var e = c / this.scale;
            this.options.al && (this.dl = o, d = d === j ? 200 : d, a = a - this.nG - this.x, b = b - this.oG - this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.ke ? this.ke : this.x, this.y = this.y > this.sf ? this.sf : this.y < this.qd ? this.qd : this.y, this.Nb.style[of] = d + "ms", this.Nb.style[mf] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Gf, this.dl = q)
        }
    };
    ...
    function Kf(a) {
        this.k = {anchor: Qc, offset: new M(0, 0), maxWidth: "100%", imageHeight: 80};
        var a = a || {}, b;
    ...
    B.bn(function (a) {
        ...
        a.addEventListener("position_changed", function () {
            a.k.visible && a.k.albumsControl === o && (b ? b.Jy(a.Yb()) : (b = new Kf(a.k.albumsControlOptions), b.ra(a)))
        });
        a.addEventListener("albums_visible_changed", function () {
            a.k.albumsControl === o ? (b ? b.Jy(a.Yb()) : (b = new Kf(a.k.albumsControlOptions), b.ra(a)), b.show()) : b.U()
        });
    ...
    x.extend(Kf.prototype, {
        Fj: function (a) {
            ...
            if (b || !this.hk[this.Xc] || !(this.hk[this.Xc].panoId == a && 3 !== this.hk[this.Xc].recoType)) {
                var c = this, d = this.XH(a);
                !b && -1 !== d && this.hk[d] && 3 !== this.hk[d].recoType ? this.Yp(d) : this.WX(function (a) {
                    for (var b = {}, d, i, k = q, l = [], m = 0, n = a.length; m < n; m++) d = a[m].catlog, i = a[m].floor, j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Mf[d]] || (b[Mf[d]] = []), b[Mf[d]].push(a[m])));
                    for (var s in b) k ? l.push({data: s + "F", index: s}) : l.push({data: Nf[s], index: s});
                    c.nH = b;
                    c.Ti = l;
                    c.Nl(a);
            ...
            if (this.Qi) a = this.FL(this.Ti), this.PQ.innerHTML = a; else {
                var a = this.FL(this.Ti), b = H("ul"), c = this;
                ...
                x.M(d, "mouseover", function () {
                    ...
                    new ub({
                        Hc: 60, hc: vb.Qs, duration: 300, va: function (c) {
            ...
            var e = this.mk.offsetWidth - 2 * d, f = this.$h.offsetLeft || this.Pc.x, f = f - d, g = -a * c;
            g > f && this.Pc.scrollTo(g + d);
            c = g - c;
            f -= e;
            c < f && (!b || b && 8 < g - f) && this.Pc.scrollTo(c + e + d)
        }, EY: function () {
            this.Pc = J() ? new Jf(this.mk, {Mo: q, py: o, si: q, Hi: q, Dn: q, WE: o, Sw: o, Sx: o}) : new Of(this.mk)
        }, U: function () {
    ...
    Of.prototype = {
        ra: function () {
            ...
            var b = this.Wg.offsetLeft, c = this;
            new ub({
                Hc: 60, hc: vb.Qs, duration: 300, va: function (d) {
    ...
    var ag = Ad.prototype;
    U(ag, {setCenter: ag.Xf, getCenter: ag.pc, getRadius: ag.TL, setRadius: ag.wf});
    var cg = yd.prototype;
    U(cg, {getPath: cg.ve, setPath: cg.me, setPositionAt: cg.vn});
    var dg = kb.prototype;
    U(dg, {getPosition: dg.ia, setPosition: dg.ta, getText: dg.nE, setText: dg.hu});
    ...
    var ig = Sc.prototype;
    U(ig, {addCopyright: ig.Dw, removeCopyright: ig.uF, getCopyright: ig.Am, getCopyrightCollection: ig.YD});
    U(window, {BMAP_MAPTYPE_CONTROL_HORIZONTAL: Uc, BMAP_MAPTYPE_CONTROL_DROPDOWN: 1, BMAP_MAPTYPE_CONTROL_MAP: 2});
    var jg = Dd.prototype;
    ...
    U(window, {BMAP_ROUTE_STATUS_NORMAL: ce, BMAP_ROUTE_STATUS_EMPTY: 1, BMAP_ROUTE_STATUS_ADDRESS: 2});
    var pg = ue.prototype;
    U(pg, {setPolicy: pg.gu});
    var qg = Ke.prototype;
    U(qg, {show: qg.show, hide: qg.U, setTypes: qg.QF, setLocation: qg.tn, search: qg.search, setInputValue: qg.Qy});
    U(pb.prototype, {});
    var rg = De.prototype;
    U(rg, {get: rg.get});
    U(Xc.prototype, {});
    U(eb.prototype, {});
    U(window, {BMAP_POINT_DENSITY_HIGH: 200, BMAP_POINT_DENSITY_MEDIUM: Qd, BMAP_POINT_DENSITY_LOW: 50});
    U(window, {
    ...
    U(window, {BMAP_CONTEXT_MENU_ICON_ZOOMIN: $c, BMAP_CONTEXT_MENU_ICON_ZOOMOUT: ad});
    U(window, {
        BMAP_SYS_DRAWER: Ka,
        BMAP_SVG_DRAWER: 1,
        BMAP_VML_DRAWER: 2,
